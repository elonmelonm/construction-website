...
const Hero = () => {
  return (
    <div id='hero' className='bg-black w-full lg:h-[700px] h-fit m-auto pt-[60px] lg:pt-[0px] lg:px-[150px] 
      px-[20px] flex justify-between items-center lg:flex-row flex-col lg:gap-5 gap-[50px] bg-cover 
      bg-center' style={{ backgroundImage: `url(${backgroundImage})` }}>
      <motion.div 
        initial="hidden"
        whileInView="visible"
        variants={slideUpVariants}
        className='lg:w-[80%] w-[90%] m-auto flex flex-col justify-center items-start lg:gap-8 gap-4'>
        <motion.h1
          variants={slideUpVariants}
        ...
        <p className='text-white text-[20px]'>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis doloribus nam dolorum fuga porro eum cumque modi molestiae eligendi. Magni quasi rem odio. Quis, quibusdam.
        </p>
        <motion.div
          initial="hidden"
          whileInView="visible"
